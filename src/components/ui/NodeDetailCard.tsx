...
import React, { memo, useState, useEffect, type FC } from 'react'
...
export const NodeDetailCard: FC<NodeDetailCardProps> = memo(
  ({
    nodeText,
    nodeType,
    summaryTitle,
            ...
            {onNodeTextChange && isEditingText ? (
              ...
              <>
                ...
                {hasTranslatedContent ? (
                  <div
                    className="mt-3 whitespace-pre-wrap break-words text-sm leading-7 text-slate-700"
                    style={{ maxWidth: '65ch' }}
                  >
                    {normalizedTranslatedTitle.length > 0 ? (
                    ...
                    {normalizedTranslatedTextContent.length > 0
                      ? renderMarkdownEmphasis(
                          normalizedTranslatedTextContent,
                          citations
                        )
                      : null}
        ...
        <div>
          ...
          {isCitationsExpanded &&
            (citations.length > 0 ? (
              ...
              <p
                id="inspector-citations-content"
